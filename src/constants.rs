...
lazy_static! {
    ...
    pub static ref Y_GATE: QMatrix =
        QMatrix::from_data(vec![ZERO, complex!(0.0, 1.0), complex!(0.0, -1.0), ZERO]);
    ...
    pub static ref S_GATE: QMatrix = QMatrix::from_data(vec![ONE, ZERO, ZERO, complex!(0.0, 1.0)]);
